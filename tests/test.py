...
def test_imo_2025_p2(forward=True):
    """
    constructions: 42
    theorems: 204
    """
    ...
    if forward:
        ...
        debug_execute(gc.decompose,
                      ['perpendicular_bisector_determination_center_line_and_common_chord(Ω,Γ,M,N,a,A,B,v)'])
...
if __name__ == '__main__':
    test_imo_2025_p2(forward=False)
